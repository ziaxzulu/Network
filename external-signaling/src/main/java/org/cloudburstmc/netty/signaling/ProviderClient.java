...
public final class ProviderClient implements AutoCloseable {
    ...
    private void heartbeat() throws Exception {
        ...
        for (int exchange = 0; exchange < 3; exchange++) try {
            ...
            Health health = healthSupplier.get();
            body.addProperty("acceptingPlayers", health.acceptingPlayers()
            ...
            if (profileSnapshot != null && profileSnapshot.candidateRevision() > 0) {
                ...
                if (!probes.equals(profile.getAsJsonArray("candidates"))) data.add("probeCandidates", probes);
            ...
            if (config.assistedJoins()) {
                assistedAuthority = assistedMode && lastControlCarrier.equals("websocket") && profileSnapshot != null && health.acceptingPlayers() && hostState.equals("serving")
