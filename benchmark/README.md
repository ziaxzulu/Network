...
The current runner targets RakNet established-channel bandwidth, latency, fanout, fairness, disappearing-client, batched game-traffic, and impaired-network matrix runs. See [`docs/benchmarking.md`](docs/benchmarking.md) for usage and [`docs/baseline-matrix.md`](docs/baseline-matrix.md) for the recurring baseline plan.
